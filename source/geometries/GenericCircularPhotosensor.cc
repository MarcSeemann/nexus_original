...
GenericCircularPhotosensor::GenericCircularPhotosensor(G4String name, G4double size):
  GenericCircularPhotosensor(name, size, size)
{
}
...
void GenericCircularPhotosensor::Construct()
{
  ...
  G4Tubs* case_solid_vol = new G4Tubs(name, 0, radius_/ 2., thickness_/ 2. , 0, twopi);
  ...
  G4Tubs* window_solid_vol = new G4Tubs(name, 0, reduced_radius_ / 2., window_thickness_ / 2., 0, twopi);
  ...
  if (with_wls_coating_) {
    ...
    G4Tubs* wls_solid_vol = new G4Tubs(name, 0, radius_ / 2., wls_thickness_ / 2., 0, twopi);
