...
#ifndef GENERIC_CIRCULARPHOTOSENSOR_H
#define GENERIC_CIRCULARPHOTOSENSOR_H
...
namespace nexus {
  ...
  public:
    ...
    GenericCircularPhotosensor(G4String name,   G4double radius, G4double thickness = 2.0 * mm);

    // Constructor for a circular sensor
    GenericCircularPhotosensor(G4String name, G4double size);
  ...
  inline G4double GenericCircularPhotosensor::GetRadius()       const { return radius_; }
